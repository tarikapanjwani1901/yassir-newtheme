        ...
        <div class="row  p-0">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" id="add_advertise" enctype="multipart/form-data" method="post" files="true" action="{{ route('vendor.advertise.update',[$advertise->id]) }}">
                            <div class="row p-0">
                                <input type="hidden" name="vendor_id" id="vendor_id" value="{{ \Auth::user()->id }}">
                                <div class="col-md-12">
