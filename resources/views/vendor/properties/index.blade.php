        ...
        <div class="row  p-0">
            <div class="col-lg-12">
                ...
                <div class="card-header pb-3 pt-3 text-uppercase">
                    	Properties
                        	        <a href="{{url('/vendor/properties/add')}}" class="btn btn btn-success text-uppercase" data-toggle="tooltip" title="Add New Property">Add New Property</a>
                        ...
                        <div class="row p-0">
                            ...
                            <div class="col-md-3">
                            	<input type="submit" class="btn btn-primary" value="Submit">
                                 ...
                                 <a href="{{url('/vendor/properties')}}" data-toggle="tooltip" title="Reset"><input type="button" class="btn btn-light" value="Reset"></a>
                            </div>
                        </div>   
                        </form>          	
...
<script>
    jQuery(document).ready(function () {
        ...
        jQuery("#btn_ok_1").on('click',function(){
            ...
            $.ajax({
            type:'POST',
            url:'/vendor/properties/delete/'+id,
            data:{_token: token},
