    ...
    <div class="ltn__product-slider-area ltn__product-gutter pt-50 pb-50 plr--7">
        <div class="container-fluid">
            ...
            <div class="row ltn__product-slider-item-four-active-full-width slick-arrow-1">
                <!-- ltn__product-item -->
                @if(isset($rented_properties) && sizeof($rented_properties)>0)
                @foreach($rented_properties as $k=>$v)
                <div class="col-lg-12">
                    <div class="ltn__product-item ltn__product-item-4 text-center---">
                        <div class="product-img">
                            ...
                            <div class="product-img-location-gallery">
                                <div class="product-img-location">
                                    <ul>
                                        <li>
                                            <a href="#"><i class="flaticon-pin"></i>{{ $v->address }}</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="product-img-gallery">
                                    <ul>
                                        <li>
                                            <a href="#"><i class="fas fa-camera"></i> {{ $v->count }}</a>
                                        </li>
                                        <li>
                                            <a href="#"><i class="fas fa-film"></i> 0</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="product-info">
                            ...
                            <h2 class="product-title"><a href="#">{{$v->project_name }}</a></h2>
                            <!--<div class="product-description">
                                <p>Beautiful Huge 1 Family House In Heart Of <br>
                                    Westbury. Newly Renovated With New Wood</p>
                            </div>-->
                            <ul class="ltn__list-item-2 ltn__list-item-2-before">
                                <li><span>{{ $v->number_of_bedrooms}} <i class="flaticon-bed"></i></span>
                                    Bedrooms
                                </li>
                                <li><span>{{ $v->number_of_bathrooms}} <i class="flaticon-clean"></i></span>
                                    Bathrooms
                                </li>
                                <li><span>{{ $v->carpet_area}} <i class="flaticon-square-shape-design-interface-tool-symbol"></i></span>
                                {{ $v->property_areas}} 
                                </li>
                            </ul>
                        </div>
