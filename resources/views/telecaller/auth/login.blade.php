                                ...
                                <div class="auth-form">
									<div class="text-center mb-3">
										<a href="index.html">
                                            ...
                                            <h1 class="text-center mb-4 text-white">Telecaller Login</h1>
                                        </a>
									</div>
                                    ...
                                    @else
                                        ...
                                        <form method="post" id="login_form" action="{{ route('telecallergenerateOTP') }}" autocomplete="off">
                                            {{ csrf_field() }}
                                            <div class="form-group">
