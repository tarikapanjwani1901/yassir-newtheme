                        ...
                        <form method="post" id="adduser" enctype="multipart/form-data">
                             	<div class="row p-0">
                                	<div class="col-md-2">
                                         ...
                                         <label class="control-label">Status<span class="required_field">*</span> </label>    
                                     	       {!! Form::select('status', $status, $u->status,['class' => 'select2 form-control required']) !!}
                                    </div> 	
                                    </div>
                                    <div class="col-md-2">
                                   		<div class="form-group">
                                         <label class="control-label">User Role<span class="required_field">*</span> </label>    
                                     	       {!! Form::select('user_role', $user_role, $u->user_role,['class' => 'select2 form-control required']) !!}
                                    </div> 	
                                    </div>
                                    <div class="col-md-4">
                                   		<div class="form-group">
                                         <label class="control-label">User Name<span class="required_field">*</span> </label>    
                                     	 <input type="text" placeholder="User Name" value="{{$u->user_name}}" name="user_name" class="form-control required" />
                                    </div> 	
                                    </div>
                                    <div class="col-md-4">
                                   		<div class="form-group">
                                         <label class="control-label">First Name<span class="required_field">*</span> </label>    
                                     	 <input type="text" placeholder="First Name" value="{{$u->first_name}}" name="first_name" class="form-control required" />
                                    </div> 	
                                    </div>
                                	<div class="col-md-3">
                                   		<div class="form-group">
                                         <label class="control-label">Last Name<span class="required_field">*</span> </label>    
                                         <input type="text" placeholder="Last Name" value="{{$u->last_name}}" name="last_name" class="form-control required" />
                                    </div> 	
                                    </div>
                                	...
                                	<div class="col-md-3">
                                         ...
                                         <input type="text" placeholder="Email" value="{{$u->email}}" name="email" class="form-control email required" />
                                    </div> 	
                                    </div>
                                	...
                                	<div class="col-md-3">
                                         ...
                                         <input type="text" placeholder="Company Name" value="{{$u->company_name}}" name="company_name" class="form-control required" />
                                    </div> 	
                                    </div>
                                    <div class="col-md-4">
                                   		<div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                         ...
                                         <label class="control-label">Date of Birth<span class="required_field">*</span> </label>    
                                     	 <input type="text" placeholder="Date Of Birth" value="{{$u->dob}}" name="dob" class="form-control datepicker required" />
                                    </div> 	
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                         ...
                                         <label class="control-label">Gender<span class="required_field">*</span> </label>    
                                          {!! Form::select('gender', $gender, $u->gender,['class' => 'select2 form-control required']) !!}
                                    </div> 	
                                    </div>	
                                </div>
                                ...
                                <div class="row p-0">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea style="resize:none;" name="bio" class="form-control">{{$u->bio}}</textarea>
                                    </div> 	
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="fileinput-preview thumbnail" style="max-width: 200px; max-height: 200px;">
                                           	  @if($u->pic)
                                                        @if((substr($u->pic, 0,5)) == 'https')
                                                            <img src="{{ $u->pic }}" alt="img" class="img-responsive"/>
                                                        @else
                                                            <img src="{!! url('/').'/images/users/'.$u->id .'/'. $u->pic!!}" alt="img" class="img-responsive"/>
                                                        @endif
                                                    @endif
                                           </div>
                                        <br />
                           ...
                           <div class="row p-0">
                              ...
                              <div class="col-md-3">
                                 <div class="form-group">
                                    <label class="control-label">State <span class="required_field">*</span></label>
                                     {!! Form::select('state', $state,$u->state,['class' => 'select2 required form-control', 'id' => 'state']) !!}
                              ...
                              <div class="col-md-3">
                                 <div class="form-group">
                                    <label class="control-label">City <span class="required_field">*</span></label>
                                     {!! Form::select('city', $city,$u->city,['class' => 'select2 required form-control', 'id' => 'city']) !!}
                                 </div>
                              </div>
                              <div class="col-md-3">
                                 <div class="form-group">
                                    <label class="control-label">Sub City <span class="required_field">*</span></label>
                                     {!! Form::select('sub_city', $sub_city,$u->sub_city,['class' => 'select2 required form-control', 'id' => 'sub_city']) !!}
                                 </div>
                              </div>
                              <div class="col-md-9">
                                 <div class="form-group">
                                    <label class="control-label" for="address">Address <span class="required_field">*</span></label>
                                    <input type="text" class="form-control required" value="{{$u->address}}"  name="address" id="address" placeholder="Address" >
                                 </div>
                              </div>
                              ...
                              <div class="col-md-3">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control required" value="{{$u->zipcode}}"  name="zipcode" id="zipcode" placeholder="Zip Code"  >
                                 </div>
                              </div>
                           </div>
