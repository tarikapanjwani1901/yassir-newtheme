                             	...
                             	<div class="row p-0">
                                	...
                                	<div class="col-md-3">
                                         ...
                                         <label class="control-label">Mobile Number<span class="required_field">*</span> </label>    
                                     	 <input type="text" placeholder="Mobile Number" min="10" name="mobile" class="form-control number required" />
                                    </div> 	
                                    </div>
                                	<div class="col-md-3">
                                   		<div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                         ...
                                         <input type="text" placeholder="GST Number" name="gst_number" class="form-control" />
                                    </div> 	
                                    </div>
                                    <div class="col-md-4">
                                   		<div class="form-group">
