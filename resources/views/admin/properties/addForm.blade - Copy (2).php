...
.select2-container{ width:100% !important;}
 .delelteItem,.delelteItemCommercialArea,.delelteItemCommercialSpaceArea,.delelteItemIndustrialArea,.delelteItemPloatArea,.delelteItemRentCommercialAreaHospital{cursor:pointer;
	background: red;
	color: #fff;
	/* padding: 11px; */
	border-radius: 91px;
         ...
         <div class="card-body">
                	...
                	{!! Form::select('possession_year', $yearList,'',['class' => 'select2 required form-control']) !!}
                        ...
                        <div class="rent_commercial_prop rent_commercial_office_prop">
                        	<div class="row">
                              ...
                              <div class="col-md-3">
                                 <div class="form-group">
                                    <label>Office Number<span class="required_field">*</span></label>
                              ...
                              <div class="col-md-3">
                                 <div class="form-group">
                                    <label>Property Available Date<span class="required_field">*</span></label>
                                    <input type="text" placeholder="Property Available Date"  name="PropertyAvailableDate" class="form-control required" />
                                 </div>
                              </div>
                              <div class="col-md-3">
                                 <div class="form-group">
                              ...
                              <div class="col-sm-3"><label class="control-label">Advance Rent<span class="required_field">*</span></label><input type="text" class="form-control" placeholder="Advance Rent" value=""></div>
                              
                              <div class="col-sm-3">
            
                <label class="control-label">
                Deposit Amount<span class="required_field">*</span>
                </label>
                <input type="text" class="form-control number required" placeholder="Deposit Amount" value="">
                </div>
            ...
            &nbsp;<label>Price Negotiable</label>&nbsp;&nbsp;&nbsp;
			 ...
			 <div class="row"><div class="col-sm-4">
                ...
                <label class="control-label">
                Duration of Aggrement<span class="required_field">*</span>
                </label>
                <input type="text" class="form-control number required" placeholder="DurationofAggrement" value="">
                </div>
             ...
             <label class="control-label">
             Month Of Notice<span class="required_field">*</span>
             </label>
             <input type="text" class="form-control number required" placeholder="Month Of Notice" value="">
             </div>
        	<div class="col-sm-4">
            <label class="control-label">
            What makes your property unique<span class="required_field">*</span>
            </label>
            <input type="text" class="form-control number required" placeholder="What makes your property unique" value="">
            </div>
        	</div>
             ...
             <label class="control-label">
             Yearly Rent is excepted to Increase By<span class="required_field">*</span>
                </label>
                <input type="text" class="form-control required" placeholder="Yearly Rent is excepted to Increase By" value="">
                </div>
        	</div>
            ...
            <div class="row"><div class="col-sm-3">
                ...
                <label class="control-label">
                Long Turm Lease<span class="required_field">*</span>
                </label>
                <input type="file" name="propertyDetails['+property_type+']['+value+'][LongTurmLease]" class="form-control number required" placeholder="Duration of Agreement" value="">
                </div>
			 ...
			 <div class="col-sm-3">
                ...
                <input type="file" name="propertyDetails['+property_type+']['+value+'][AdharCard]" class="form-control number required" placeholder="Month Of Notice" value="">
                </div>
			 ...
			 <div class="col-sm-3">
                ...
                <input type="file" name="propertyDetails['+property_type+']['+value+'][MunicipalityTaxBill]" class="form-control number required" placeholder="What makes your property unique" value="">
                </div>
                           ...
                           <div class="row ">
                              <div class="col-md-3">
                                 <div class="form-group">
                                    ...
                                    <input type="text" placeholder="No of washrooms"  name="number_of_parking" class="form-control required number" />
                                 </div>
                              </div>
                	...
                	{!! Form::select('Commercialpossession_year', $yearList,'',['class' => 'select2 required form-control']) !!}
                     ...
                     <div id="step4" class="tab-pane" role="tabpanel">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-12 rent_residential_independent_hide rent_residential_flat_hide rent_residential_farmhouse_hide rent_industrial_prop_hide rent_commerical_office_prop_hide rent_commerical_retail_prop_hide ">
                              <div class="form-group">
                                 <div class="row">
                           ...
                           <div class="col-md-6 rent_industrial_prop_hide rent_commerical_retail_prop_hide">
                              <div class="form-group">
                                 <div class="row">
                        ...
                        <div class="row rent_industrial_prop_hide rent_commerical_office_prop_hide rent_commerical_retail_prop_hide rent_commercial_hospital_prop">
...
html += '<div class="row"><div class="col-md-3">';
                ...
                html += '</label>';
                html += '<input type="text"  style="display: inline-block;width: auto;margin-left: 5px;" name="propertyDetails['+property_type+']['+value+'][no_of_cover_parking]" class="form-control number required" placeholder="No of Penthouse" value="">';
                html += '</div></div>';
...
html += '<div class="row"><div class="col-md-3">';
            ...
            html += '<label class="control-label">';
                ...
                html += '<label class="control-label">';
                html += 'Property Available Date<span class="required_field">*</span>';
                html += '</label>';
                html += '<input type="text" name="propertyDetails['+property_type+']['+value+'][PropertyAvailableDate]" class="form-control number required" placeholder="Property Available Date" value="">';
                html += '</div>';
             if(property_type=="Apartment And Flat"){
			 ...
			 html += '<div class="col-sm-3">';
                ...
                html += '<label class="control-label">';
                html += 'Advance Rent<span class="required_field">*</span>';
                html += '</label>';
                html += '<input type="text" name="propertyDetails['+property_type+']['+value+'][AdvanceRent]" class="form-control number required" placeholder="Advance Rent" value="">';
                html += '</div>';
			 ...
			 html += '<div class="col-sm-3">';
                ...
                html += '<label class="control-label">';
                html += 'Deposit Amount<span class="required_field">*</span>';
                html += '</label>';
                html += '<input type="text" name="propertyDetails['+property_type+']['+value+'][DepositAmount]" class="form-control number required" placeholder="Deposit Amount" value="">';
                html += '</div>';
            ...
            html += '</div>';
			 ...
			 html += '<div class="row"><div class="col-sm-4">';
                ...
                html += '<label class="control-label">';
                html += 'Duration of Aggrement<span class="required_field">*</span>';
                html += '</label>';
                html += '<input type="text" name="propertyDetails['+property_type+']['+value+'][DurationofAggrement]" class="form-control number required" placeholder="DurationofAggrement" value="">';
                html += '</div>';
			 ...
			 html += '<div class="col-sm-4">';
                ...
                html += '<label class="control-label">';
                html += 'Month Of Notice<span class="required_field">*</span>';
                html += '</label>';
                html += '<input type="text" name="propertyDetails['+property_type+']['+value+'][MonthOfNotice]" class="form-control number required" placeholder="Month Of Notice" value="">';
                html += '</div>';
			 ...
			 html += '<div class="col-sm-4">';
                ...
                html += '<label class="control-label">';
                html += 'What makes your property unique<span class="required_field">*</span>';
                html += '</label>';
                html += '<input type="text" name="propertyDetails['+property_type+']['+value+'][Whatmakesyourpropertyunique]" class="form-control number required" placeholder="What makes your property unique" value="">';
                html += '</div>';
            ...
            html += '</div>';
			 ...
			 html += '<div class="row"><div class="col-sm-3">';
                ...
                html += '<label class="control-label">';
                html += 'Long Turm Lease<span class="required_field">*</span>';
                html += '</label>';
                html += '<input type="file" name="propertyDetails['+property_type+']['+value+'][LongTurmLease]" class="form-control number required" placeholder="Duration of Agreement" value="">';
                html += '</div>';
			 ...
			 html += '<div class="col-sm-3">';
                ...
                html += '</label>';
                html += '<input type="file" name="propertyDetails['+property_type+']['+value+'][AdharCard]" class="form-control number required" placeholder="Month Of Notice" value="">';
                html += '</div>';
			 ...
			 html += '<div class="col-sm-3">';
                ...
                html += '</label>';
                html += '<input type="file" name="propertyDetails['+property_type+']['+value+'][MunicipalityTaxBill]" class="form-control number required" placeholder="What makes your property unique" value="">';
                html += '</div>';
            ...
            html += '</div>';
			 ...
			 html += '<div class="row"><div class="col-sm-12">';
                ...
                html += '<label class="control-label">';
                html += 'Yearly Rent is excepted to Increase By<span class="required_field">*</span>';
                html += '</label>';
                html += '<input type="text" name="propertyDetails['+property_type+']['+value+'][YearlyRentisexceptedtoIncreaseBy]" class="form-control required" placeholder="Yearly Rent is excepted to Increase By" value="">';
                html += '</div>';
...
jQuery(".hospitality_prop,.IndependentHomeSubType,.sell_plotting_prop,.sell_vacant_land_prop,.rentapartmentsales,.rent_industrial_prop,.rent_commercial_prop,.rent_retail_type,.rent_commerical_retail_prop,.rent_commerical_office_prop,.rent_commercial_hospital_prop").hide();
...
jQuery(document).on("change","#sub_category,#sell_commercial_property_type,#property_type,#property_for,#rentwhatkindofpropetyisitCommercial",function(e) {
    HideShowDependsubCategory();
});
