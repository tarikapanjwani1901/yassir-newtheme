                             	...
                             	<div class="row p-0">
                                	...
                                	<div class="col-md-12">
                                         ...
                                         <label class="control-label">Blog<span class="required_field">*</span> </label>    
                                           {!! Form::select('blog_id', $blogs, '',['class' => 'select2 form-control']) !!}
                                    </div> 	
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                         ...
                                         <input name="email" type="text" class="form-control email required" autocomplete="off" >
                                    </div> 	
                                    </div>
                                    <div class="col-md-6">
                                   		<div class="form-group">
                                         <label class="control-label">Website</label>    
                                         <input id="website" name="website" type="text" class="form-control url" autocomplete="off" >
                                    </div> 	
                                    </div>
                                    <div class="col-md-6">
                                   		<div class="form-group">
                                         <label class="control-label">Status<span class="required_field">*</span> </label>    
                                          {!! Form::select('status', $status, '',['class' => 'select2 form-control']) !!}
                                    </div> 	
                                    </div>
                                    <div class="col-md-12">
                                   		<div class="form-group">
