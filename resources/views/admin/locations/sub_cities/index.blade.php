                        ...
                        <div class="col-md-12">
                            <form method="get" class="padd15" name="search" action="sub_cities_search"  autocomplete="off">
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <a href="{{url('/')}}/admin/sub_cities" data-toggle="tooltip" title="" data-original-title="Reset" class="btn btn-primary exporting"><i class="fa fa-refresh" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                                </form>
                        </div>
